...
const connector: ConnectorServer = {
  ...
  handlers: {
    'stripe.balance': (s) =>
      withFallback(
        hasEnv(ENV),
        () => cached(cacheKeyFor('stripe.balance', s), CACHE_TTL_SECONDS, () => liveBalance(s)),
        () => mockBalance(s),
        'stripe.balance',
      ),
    'stripe.revenue': (s) =>
      withFallback(
        hasEnv(ENV),
        () => cached(cacheKeyFor('stripe.revenue', s), CACHE_TTL_SECONDS, () => liveRevenue(s)),
        () => mockRevenue(s),
        'stripe.revenue',
      ),
    'stripe.payments': (s) =>
      withFallback(
        hasEnv(ENV),
        () => cached(cacheKeyFor('stripe.payments', s), CACHE_TTL_SECONDS, () => livePayments(s)),
        () => mockPayments(s),
        'stripe.payments',
      ),
  },
