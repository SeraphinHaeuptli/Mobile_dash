...
const connector: ConnectorServer = {
  ...
  isLive: () => hasEnv(ENV),
  handlers: {
    'stripe.balance': (s) => withFallback(() => liveBalance(s), () => mockBalance(s), { envKeys: ENV, label: 'stripe.balance' }),
    'stripe.revenue': (s) => withFallback(() => liveRevenue(s), () => mockRevenue(s), { envKeys: ENV, label: 'stripe.revenue' }),
    'stripe.payments': (s) => withFallback(() => livePayments(s), () => mockPayments(s), { envKeys: ENV, label: 'stripe.payments' }),
  },
};
